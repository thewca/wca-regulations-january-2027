...
- 2j) The WCA Delegate may disqualify a competitor from specific attempts and/or events.
    ...
    - 2j2) Results from attempts that are completed when the disqualification is applied must not be disqualified. Exception: cheating or defrauding (see [Regulation 2k2a](regulations:regulation:2k2a)), breaching scamble secrecy (see [Regulation 2g3](regulations:regulation:2g3)).
