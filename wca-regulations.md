...
- I4) Head to Head speed solving procedures:
    ...
    - I4c) Inspection:
        ...
        - I4c5) When 14 seconds of inspection have elapsed, the announcer calls "GO". The competitor must start the solve (see [Regulation A4d](regulations:regulation:A4d)) at this point. Penalty for delaying the start of the solve: disqualification of the attempt (DNF) at the discretion of the judge.
