...
- 2j) The WCA Delegate may disqualify a competitor from specific attempts and/or events.
    ...
    - 2j2) Results from attempts that are completed when the disqualification is applied must not be disqualified. Exceptions: cheating or defrauding (see [Regulation 2k2a](regulations:regulation:2k2a)), being unavailable for judging for a round they are competing in (see [Regulation 1e2a](regulations:regulation:1e2a)).
