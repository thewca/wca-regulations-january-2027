...
- 1e) Each event must have one or more judges.
    ...
    - 1e2) Every competitor must be available for judging. If required to judge, a competitor may be excused only for a legitimate reason (e.g. being unfamiliar with a puzzle), at the discretion of the WCA Delegate. Penalty: disqualification from an event, multiple events, or all events at that competition (see [Regulation 2k](regulations:regulation:2k)).
        -1e2a) The WCA Delegate may disqualify a competitor for a completed round if the competitor was not available for judging during that round. Retroactive disqualifications should only be applied when the competitor did not have a legitimate reason for not judging, and the competitor unambiguously refused to judge. Retroactive disqualifications for failing to judge may only be applied during the competition (see [Regulation 9u](regulations:regulation:9u)).
...
- 2j) The WCA Delegate may disqualify a competitor from specific attempts and/or events.
    ...
    - 2j2) Results from attempts that are completed when the disqualification is applied must not be disqualified. Exceptions: cheating or defrauding (see [Regulation 2k2a](regulations:regulation:2k2a)), being unavailable for judging for a group they are competing in (see [Regulation 1e2a](regulations:regulation:1e2a)).
